...
parser.add_argument("--step", type=int, default=5,
                    help="Sets the learning rate to the initial LR decayed by momentum every n epochs, Default=5")
...
def train(training_data_loader, optimizer, model, criterion, epoch):
    ...
    for iteration, batch in enumerate(training_data_loader, 1):
        ...
        if iteration % 100 == 0:
            ...
            print("===> {} Epoch[{}]({}/{}): Loss: {:.10f}".format(lc_time, epoch, iteration, len(training_data_loader),
                                                                   loss.data[0]))
